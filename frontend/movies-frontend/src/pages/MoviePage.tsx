    ...
    <main className="movie-details">
      ...
      <div className="movie-info">
        ...
        <h3 className="movie-director">
          Reżyser: {movie.directorName} {movie.directorSurname}
        </h3>
        <h4 className="movie-studio">Wytwórnia: {movie.studio || 'Brak danych'}</h4>
        <h4 className="movie-budget">Budżet filmu: {movie.budget} $</h4>
      </div>
